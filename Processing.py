...
class Processing():
    ...
    def cross_validation(self, original_data):
        ...
        # print('fold2 =', fold2.shape)
        # print('fold3 =', fold3.shape)
        # print('fold4 =', fold4.shape)
        # print('fold5 =', fold5.shape)
        # print('fold6 =', fold6.shape)
        # print('fold7 =', fold7.shape)
        # print('fold8 =', fold8.shape)
        # print('fold9 =', fold9.shape)
        # print('fold10 =', fold10.shape)
        ...
        # print('training_data_1 =', training_data_1.shape)
        ...
        training_data_4 = np.concatenate(
            (fold2, fold3, fold1, fold5, fold6, fold7, fold8, fold9, fold10))
        ...
        training_data_5 = np.concatenate(
            (fold2, fold3, fold4, fold1, fold6, fold7, fold8, fold9, fold10))
        ...
        training_data_6 = np.concatenate(
            (fold2, fold3, fold4, fold5, fold1, fold7, fold8, fold9, fold10))
        ...
        training_data_7 = np.concatenate(
            (fold2, fold3, fold4, fold5, fold6, fold1, fold8, fold9, fold10))
        ...
        training_data_8 = np.concatenate(
            (fold2, fold3, fold4, fold5, fold6, fold7, fold1, fold9, fold10))
        ...
        training_data_9 = np.concatenate(
            (fold2, fold3, fold4, fold5, fold6, fold7, fold8, fold1, fold10))
        ...
        training_data_10 = np.concatenate(
            (fold2, fold3, fold4, fold5, fold6, fold7, fold8, fold9, fold1))
        testing_data_10 = fold10
        training_data_list.append(training_data_10)
        testing_data_list.append(testing_data_10)

        # print((training_data_list[1].shape))
        # print((testing_data_list[1].shape))
